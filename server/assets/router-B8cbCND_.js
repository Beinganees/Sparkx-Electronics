...
const appCss = "/sparkx-electronics/assets/styles-DKhkMOJV.css";
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "fixed top-0 left-0 right-0 z-50 glass-strong", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 group", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-black text-xl sm:text-2xl tracking-wider text-gradient-accent", children: "SPARKX" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "hidden lg:flex items-center gap-7", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          to: l.to,
          ...
          children: [
            l.label,
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-1 left-0 w-0 h-0.5 bg-primary transition-all group-hover:w-full" })
          ]
        }
      ) }, l.to)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "relative mt-20 border-t border-border bg-darker/80", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 py-14 grid gap-10 md:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg bg-gradient-primary flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-5 h-5 text-primary-foreground" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-black text-xl text-gradient-accent", children: "SPARKX" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "Husenpur Musalman में बिजली से जुड़ी हर ज़रूरत का भरोसेमंद साथी। 221+ ओरिजिनल प्रोडक्ट्स, वारंटी और एक्सपर्ट सर्विस।" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-primary mb-3 text-sm tracking-wide", children: "क्विक लिंक" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", className: "hover:text-primary", children: "सेवाएं" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/products", className: "hover:text-primary", children: "प्रोडक्ट कार्ड" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/catalog", className: "hover:text-primary", children: "पूरी लिस्ट" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", className: "hover:text-primary", children: "संपर्क" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-primary mb-3 text-sm tracking-wide", children: "संपर्क" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-4 h-4 text-primary mt-0.5" }),
            " 9120795494"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4 text-primary mt-0.5" }),
            " Husenpur Musalman, Ambedkar Nagar 224181"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-4 h-4 text-primary mt-0.5" }),
            " sparkx_electronitcs"
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-primary mb-3 text-sm tracking-wide", children: "सोशल" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", "aria-label": "Facebook", className: "w-10 h-10 rounded-full glass flex items-center justify-center text-primary hover:bg-primary hover:text-primary-foreground transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Share2, { className: "w-4 h-4" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", "aria-label": "Instagram", className: "w-10 h-10 rounded-full glass flex items-center justify-center text-primary hover:bg-primary hover:text-primary-foreground transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "w-4 h-4" }) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border py-5 text-center text-xs text-muted-foreground", children: [
      ...
      " SparkX Electricals. सभी अधिकार सुरक्षित।"
    ] })
  ] });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.a,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 rounded-full pulse-glow" })
      ]
    }
  );
}
function SiteBackground() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-blobs", "aria-hidden": "true" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid-pattern", "aria-hidden": "true" })
  ] });
}
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-7xl font-black text-gradient-accent", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-4 text-xl font-semibold text-foreground", children: "पेज नहीं मिला" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "आप जो पेज ढूंढ रहे हैं वो मौजूद नहीं है।" }),
...
const Route$6 = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "SparkX Electricals — Husenpur Musalman, Ambedkar Nagar में 221+ ओरिजिनल इलेक्ट्रिकल प्रोडक्ट्स, मोटर/पंखा रिपेयर, हाउस वायरिंग और इंस्टॉलेशन।"
      },
...
function RootShell({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { lang: "hi", children: [
...
const $$splitComponentImporter$5 = () => import("./services-2AvCALtT.js");
const Route$5 = createFileRoute("/services")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "मोटर/पंखा रिपेयर, हाउस वायरिंग, इंडस्ट्रियल वायरिंग, LED इंस्टॉलेशन और बहुत कुछ।"
    }, {
      property: "og:title",
      content: "इलेक्ट्रिकल सेवाएं • SparkX"
    }, {
      property: "og:description",
      content: "घर, दुकान, फैक्ट्री के लिए एक्सपर्ट इलेक्ट्रिकल सॉल्यूशन।"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./products-DNdAg3zK.js");
const Route$4 = createFileRoute("/products")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "हर प्रोडक्ट के साथ उपयोग, इंस्टॉलेशन और सर्विसिंग गाइड — फैन, MCB, बल्ब, पंप, इन्वर्टर और बहुत कुछ।"
    }, {
      property: "og:title",
      content: "प्रोडक्ट कार्ड्स • SparkX"
    }, {
      property: "og:description",
      content: "TOOFAN, HAVELLS, CROMPTON, ANCHOR, LUMINOUS की पूरी जानकारी।"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./contact-B40aTq-F.js");
const Route$3 = createFileRoute("/contact")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./catalog-Da68Yshk.js");
const Route$2 = createFileRoute("/catalog")({
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: "प्रोडक्ट कैटलॉग • SparkX"
    }, {
      property: "og:description",
      content: "हर ब्रांड का स्टॉक, हर ज़रूरत का सॉल्यूशन।"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./about-BiqC2Fpr.js");
const Route$1 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: "हमारे बारे में • SparkX"
    }, {
      property: "og:description",
      content: "5+ साल अनुभव • 1500+ ग्राहक • 221+ प्रोडक्ट्स"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-DAomWtMy.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Husenpur Musalman, Ambedkar Nagar में 221+ इलेक्ट्रिकल प्रोडक्ट्स, मोटर/पंखा रिपेयर, हाउस वायरिंग और एक्सपर्ट इंस्टॉलेशन।"
    }, {
      property: "og:title",
      content: "SparkX Electricals • भरोसेमंद इलेक्ट्रिकल पार्टनर"
    }, {
      property: "og:description",
...
const CatalogRoute = Route$2.update({
  id: "/catalog",
  path: "/catalog",
  getParentRoute: () => Route$6
});
