...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Dj7yqQDn.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-B8cbCND_.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "sparkx-electronics";
var SERVER_FN_BASE = "/sparkx-electronics/_serverFn/";
